...
const AddNovelForm = ({state, dispatch}) => {
    ...
    const addNovelFunction = e => {
        ...
        axios.post('http://localhost:8998/api/v1/novels', {title, description, chapters, language, author, year, status_in_coo, completely_translated, readers, image, more_info, read_online})
            .then(response=>{
